// frontend/src/components/avatar/barrel-trigger.tsx — Beergate v4 FASE 1
// Floating barrel button that summons the AI genie avatar ("El Genio Cervecero")
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="barrel-trigger fixed bottom-20 right-20 md:bottom-6 md:right-[120px] z-[1000] w-16 h-16 md:w-[64px] md:h-[64px] rounded-full flex items-center justify-center cursor-pointer"
          style={{
            filter: isActive
