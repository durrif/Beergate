      ...
      <div className="hidden lg:flex flex-col justify-between w-[480px] p-10 relative z-10">
        <div>
          <div className="flex items-center gap-3 mb-16">
            <img src="/favicon.svg" alt="Beergate" className="w-10 h-10 drop-shadow-[0_0_16px_rgba(212,160,74,0.3)]" />
            <span className="text-xl font-bold amber-text">Beergate</span>
          </div>
        ...
        <p className="text-xs text-text-tertiary">
          &copy; {new Date().getFullYear()} Beergate &middot; Craft Brewery Control Room
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4 relative z-10">
        ...
        >
          ...
          <div className="text-center mb-8 lg:hidden">
            <img src="/favicon.svg" alt="Beergate" className="w-16 h-16 mx-auto mb-3 drop-shadow-[0_0_20px_rgba(212,160,74,0.3)]" />
